...
export default function Icons({id, uid}) {
  ...
  return (
    <div className='flex justify-start gap-5 p-2 text-gray-500'>
        <HiOutlineChat onClick={() => setOpen(!open)} className='h-8 w-8 cursor-pointer rounded-full transition duration-500 ease-in-out p-2 hover:text-sky-500 hover:bg-sky-100' />
